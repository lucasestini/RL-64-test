...
class QReplayDoubleAugmPrior8(AbstractModel):
    ...
    def __init__(self, game, **kwargs):
        ...
        if kwargs.get("load", False) is False:
            ...
            self.model.add(Dense(len(self.environment.empty*2), input_shape=self.state_size, activation="relu"))
            self.model.add(Dense(len(self.environment.empty*2), activation="relu"))
        ...
        #game.maze.size
        self.target_model.add(Dense(len(self.environment.empty*2), input_shape=self.state_size, activation="relu"))
        self.target_model.add(Dense(len(self.environment.empty*2), activation="relu"))
